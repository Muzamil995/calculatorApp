             ...
             Expanded(
               ...
               child: Padding(
                 ...
                 child: Column(children: [
                   Row(
                     children: [Button(title: 'AC',onPress: (){
                       userInput='';
                       answer='';
                       setState(() {
                   ...
                   Row(
                     children: [Button(title: '7',onPress: (){
                       userInput+='7';
                       setState(() {
                   ...
                   Row(
                     children: [Button(title: '4',onPress: (){
                         userInput+='4';
                         setState(() {
                   ...
                   Row(
                     children: [Button(title: '1',onPress: (){
                             userInput+='1';
                             setState(() {
                   ...
                   Row(
                     children: [Button(title: '0',onPress: (){
                               userInput+='0';
                               setState(() {
